...
UploadController.prototype.initialize = function () {
    ...
    self.uploadFiles(self.scope.options);
    self.forceUpdateView();
};

UploadController.prototype.uploadFiles = function (opOptions) {
    var self = this;
    self.subDirectory  = (opOptions.subDirectory) ? opOptions.subDirectory : '';
    async.eachSeries(
        self.scope.files,
        function (file, callback) {
            self.Upload.upload({
                url: '/upload',
                data: {file: file.content, subDirectory : self.subDirectory},
                ...
                //remove below code line as url is already passed in resp obj
